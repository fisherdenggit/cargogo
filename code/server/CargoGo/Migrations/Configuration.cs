namespace CargoGo.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CargoGo.Models.MyDBContext>
    {
        ...
        private void InsertBankAccountRecrods(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            //System.Data.OleDb.OleDbConnection oDbConn = new System.Data.OleDb.OleDbConnection(@"provider=microsoft.ace.oledb.12.0; Data Source=D:\myGit\销售明细-攀枝花市正源科技.accdb");
            //oDbConn.Open();
        ...
        private void InsertCompanyRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            //System.Data.OleDb.OleDbConnection oDbConn = new System.Data.OleDb.OleDbConnection(@"provider=microsoft.ace.oledb.12.0; Data Source=D:\myGit\销售明细-攀枝花市正源科技.accdb");
            //oDbConn.Open();
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
            ...
            //oDbConn.Close();
            //oDbConn.Dispose();
            /*以下为删除companies表中此前不正确的行*/
            //for (int counter = 1195; counter < 1226; counter++)
            //{
            //    try
            //    {
            //        context.Companies.Remove(context.Companies.Find(counter));
            //    }
            //    catch (Exception e)
            //    {
            ...
            for (int counter = 0; counter < ds.Tables[0].Rows.Count; counter++)
            {
                ...
                try
                {
                    totalDeliveryAmount = (decimal)ds.Tables[0].Rows[counter].ItemArray.ElementAt(17);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
                ...
                try
                {
                    totalPaymentAmount = (decimal)ds.Tables[0].Rows[counter].ItemArray.ElementAt(18);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
                ...
                try
                {
                    totalBalanceAmount = (decimal)ds.Tables[0].Rows[counter].ItemArray.ElementAt(19);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
                }
                decimal totalUninvoiceAmount = 0;
                try
                {
                    totalUninvoiceAmount = (decimal)ds.Tables[0].Rows[counter].ItemArray.ElementAt(21);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
        ...
        private void InsertComapnyDeliveryAddressRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            //System.Data.OleDb.OleDbConnection oDbConn = new System.Data.OleDb.OleDbConnection(@"provider=microsoft.ace.oledb.12.0; Data Source=D:\myGit\销售明细-攀枝花市正源科技.accdb");
            //oDbConn.Open();
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
        ...
        private void InsertContractRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            //System.Data.OleDb.OleDbConnection oDbConn = new System.Data.OleDb.OleDbConnection(@"provider=microsoft.ace.oledb.12.0; Data Source=D:\myGit\销售明细-攀枝花市正源科技.accdb");
            //oDbConn.Open();
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
            ...
            for (int counter = 0; counter < ds.Tables[0].Rows.Count; counter++)
            {
                ...
                try
                {
                    contractAmount = Convert.ToDecimal(ds.Tables[0].Rows[counter].ItemArray.ElementAt(4));
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
                ...
                try
                {
                    contractPrice = Convert.ToDecimal(ds.Tables[0].Rows[counter].ItemArray.ElementAt(5));
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
                }
                decimal contractExcutedAmount = 0;
                try
                {
                    contractExcutedAmount = Convert.ToDecimal(ds.Tables[0].Rows[counter].ItemArray.ElementAt(6));
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
        ...
        private void InsertDirectionRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            //System.Data.OleDb.OleDbConnection oDbConn = new System.Data.OleDb.OleDbConnection(@"provider=microsoft.ace.oledb.12.0; Data Source=D:\myGit\销售明细-攀枝花市正源科技.accdb");
            //oDbConn.Open();
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
        ...
        private void InsertInvoiceRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
            System.Data.DataSet ds = new System.Data.DataSet();
            oDDA.Fill(ds);
        ...
        private void InsertPaymentTypeRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
            System.Data.DataSet ds = new System.Data.DataSet();
            oDDA.Fill(ds);
        ...
        private void InsertPaymentRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            //System.Data.OleDb.OleDbConnection oDbConn = new System.Data.OleDb.OleDbConnection(@"provider=microsoft.ace.oledb.12.0; Data Source=D:\myGit\销售明细-攀枝花市正源科技.accdb");
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
            //oDbConn.Open();
        ...
        private void InsertProductRecords(CargoGo.Models.MyDBContext context, System.Data.OleDb.OleDbConnection oDbConn, String sourceTableName, String orderByFieldName)
        {
            //System.Data.OleDb.OleDbConnection oDbConn = new System.Data.OleDb.OleDbConnection(@"provider=microsoft.ace.oledb.12.0; Data Source=D:\myGit\销售明细-攀枝花市正源科技.accdb");
            //oDbConn.Open();
            System.Data.OleDb.OleDbDataAdapter oDDA = new System.Data.OleDb.OleDbDataAdapter(@"select * from " + sourceTableName + " order by " + orderByFieldName, oDbConn);
